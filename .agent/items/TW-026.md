...
A FIFTH REFUSAL SITS NEXT TO THESE — 2026-08-16. `wizard-states.md` §24.26,
*"Still too close to call"*, is the card for two or more readings since a change
that clear NONE of `reef-chemistry.md` §30's three bars. It is filed as TW-078
and it is NOT one of the four cells: §24.21 is exactly one reading in, §24.26 is
two or more that disagree. **Do not collapse them.** The gap report found §24.5
and §24.21 already being stretched over §24.26's case, which is how this class of
state gets lost — a refusal that looks like a neighbouring refusal is the one
kind of card an implementer will reuse without noticing.
