...
owner instruction, 2026-08-16 (with the target-rename sign-off): kept out of
the rename deliberately — "a correctness fix with a live parity test — do it
alone, with that test as the gate." The registry names it settled on: the
concentration branch is the aim point, the mL/day branches are the planned
dose (wizard-states.md §15, §1 field table). The field keeps the name
